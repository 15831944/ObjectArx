...
class CZcadDocument : public COleDispatchDriver
{
public:
	CZcadDocument() {} // 调用 COleDispatchDriver 默认构造函数
	CZcadDocument(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CZcadDocument(const CZcadDocument& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
