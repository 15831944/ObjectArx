...
// CZcadPlotConfiguration 包装器类

class CZcadPlotConfiguration : public COleDispatchDriver
{
public:
	CZcadPlotConfiguration() {} // 调用 COleDispatchDriver 默认构造函数
	CZcadPlotConfiguration(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CZcadPlotConfiguration(const CZcadPlotConfiguration& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
