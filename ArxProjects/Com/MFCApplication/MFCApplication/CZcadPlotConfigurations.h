...
// CZcadPlotConfigurations 包装器类

class CZcadPlotConfigurations : public COleDispatchDriver
{
public:
	CZcadPlotConfigurations() {} // 调用 COleDispatchDriver 默认构造函数
	CZcadPlotConfigurations(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CZcadPlotConfigurations(const CZcadPlotConfigurations& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
